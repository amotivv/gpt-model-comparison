 ...
 * Note: We're using approximation instead of tiktoken due to compatibility issues
 */
export async function countTokens(text: string, modelName = "gpt-4"): Promise<number> {
  // Using approximation directly since tiktoken has compatibility issues in this environment
